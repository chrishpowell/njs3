...
{
    /**
     * Calculates the arc cosine, but limits the input to the range ( -1.0 < rad
     * < +1.0 ). <BR> This avoids overflow errors. If the input is <= -1.0
     * radians, <TT>Math.PI</TT> is returned. If the input is >= 1.0 radians, 0
     * is returned.
     *
    ...
    /**
     * Calculates the arc sine, but limits the input to the range ( -1.0 < rad <
     * +1.0 ). <BR> This avoids overflow errors. If the input is less than -1
     * (radian), -PI/2 is returned. If the input is greater than 1 (radian),
     * +PI/2 is returned.
     *
     * @param arg The angle in radians
     *
    ...
    /**
     * Initializes a matrix to base (identity) values. The matrix is set as
     * follows:<TT>
     * [1][0][0] [0][1][0] [0][0][1]
     * </TT>
     *
    ...
    /**
     * Convert polar coordinates with radius to Cartesian coordinates added by
     * w. Strickling
     *
     * @param vect Vector to hold the Cartesian coordinates
     * @param lon Polar longitude
     ...
     * <P>
     * Inverting an orthonormal matrix is simple: swap rows and columns, and
     * you're done.
     */
