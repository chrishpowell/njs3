 ...
 * <P>
 * This class stores a date/time value at a precision of one second. This
 * date/time can be specified using either the Gregorian Calendar (by default)
...
public class AstroDate
{
    ...
    public AstroDate()
    {
        ...
        month = 1;
        year = 2000;
        second = 12 * Astro.SECONDS_PER_HOUR;
    }
     ...
     * from <TT>0</TT> to <TT>Astro.SECONDS_PER_DAY-1</TT>.
     */
     ...
     * This must be greater than or equal to <TT>0.0</TT> and less than
     * <TT>1.0</TT>.
     */
     ...
     * @param julian true = Julian calendar, else Gregorian
     *
     * @return The Julian Day that corresponds to this <TT>AstroDate</TT>
     * instance
     */
     ...
     * Set the day. <BR>
     *
     * @param The day part of this instance of <TT>AstroDate</TT> (1..31) Value
     * is not checked!
     */
    void setDay(int d)
    {
     ...
     * 01:59:59 inclusive.
     *
     * @return The hour of the day for this instance of <TT>AstroDate</TT>, not
     * rounded
     */
    public int hour()
    {
     ...
     *
     * @return An instance of <TT>java.util.GregorianCalendar</TT> built using
     * this instance of AstroDate.
     */
    ...
    /**
     * Convert this <TT>AstroDate</TT> instance to a <TT>String</TT>, formatted
     * to the minute. This function rounds the exact time to the nearest minute.
     * <P>
    ...
    /**
     * Convert this <TT>AstroDate</TT> instance to a String formatted to the
     * minute, with Time Zone indicator. <BR>
     * Rounds the time to the nearest minute.
     * <P>
     * The format of the returned string is  <TT>YYYY-MM-DD hh:mm TZ</TT>, where
     * <TT>TZ</TT> is a locale-specific timezone name (e.g., "EST").
     *
     * @return A formatted date/time <TT>String</TT>
     */
