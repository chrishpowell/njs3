 ...
 * These are not in DateOps because they cause a circular dependancy between
 * DateOps and AstroDate
 */
public class TimeOps
{
     ...
     *
     * @param cal A <TT>java.util.Calendar</TT> object which is used to get the
     * <TT>DST_OFFSET</TT>
