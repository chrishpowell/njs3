...
/**
 * This class wraps the VSOP87 data and provides VSOP planetary position
 * calculation functions for Mercury through Neptune (VSOP doesn't handle the
 * moon or Pluto).
 * <P>
...
public class Vsop
{
     ...
     * @return The selected element, or 0.0 if planet parameter is invalid.
     */
    ...
    /**
     * Calculate all three location elements of the specified planet at the
     * given time.
     *
     * @param loc The <TT>LocationElements</TT> instance to populate
     * @param jcen Time in Julian centuries from J2000
     * @param planet The planet position to calculate, which must be in the
     * range <TT>Planets.MERCURY</TT> to <TT>Planets.NEPTUNE</TT>
     * inclusive.
     */
