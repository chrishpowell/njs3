...
public class Nutation
{
     ...
     * <P>
     * Either dPhi or dEpsilon can be Astro.INVALID on input, in which case that
     * value is not computed. (we added this because sometimes, you want only
     * dPhi or dEpsilon; in such cases, computing _both_ is a waste of perfectly
     * good CPU time).
     *
     * @param t Time in Julian centuries from J2000.
     */
