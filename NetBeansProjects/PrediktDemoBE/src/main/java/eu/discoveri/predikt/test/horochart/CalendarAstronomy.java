 ...
 */
public class CalendarAstronomy
{
    //-------------------------------------------------------------------------
...
//  }
     ...
     * @internal
     */
    public CalendarAstronomy(Date d)
    {
        this(d.getTime());
    }
     ...
     * @internal
     */
    public CalendarAstronomy(long aTime)
    {
        time = aTime;
    }
     ...
     * @internal
     */
    public CalendarAstronomy(double longitude, double latitude)
    {
        this();
    ...
    private double getSiderealOffset() {
        if (siderealT0 == INVALID) {
            ...
            double T   = S / 36525.0; System.out.println(">> S, T: " +S+", " +T);
...
//  }
    ...
    {
        return timeOfAngle(() -> getSunLongitude(),
                            desired,
                            TROPICAL_YEAR,
                            MINUTE_MS,
                            next);
...
//    }
    ...
    public static void main(String[] args)
    {
        ...
        CalendarAstronomy ca = new CalendarAstronomy(new Date(System.currentTimeMillis()));
        System.out.println("1 Sidereal time: " +ca.getGreenwichSidereal());
        
        long jdn = LocalDateTime.of(1950, 1, 1, 12,0,0).getLong(JulianFields.JULIAN_DAY);
        System.out.println("...> 1 JDay: " +jdn);
        ca.setJulianDay(jdn);
        System.out.println("...> 2 JDay: " +ca.getJulianDay());
        System.out.println("2 Sidereal time: " +ca.getGreenwichSidereal());
        
                DecimalFormat df = new DecimalFormat("###.######");
        
        System.out.println("Normalize function 10. mod 5. should be zero: "+normalize(10.d,5.d));
        System.out.println("Normalize function 7. mod 5. should be 2.: "+normalize(7.d,5.d));
        System.out.println("Normalize function 12.3 mod 5. should be 2.3: "+df.format(normalize(12.3d,5.d)));
        System.out.println("Normalize function -12.3 mod 5. should be 2.7: "+df.format(normalize(-12.3d,5.d)));
        System.out.println("Normalize function -3135.9347 mod 360. should be 104.0652: "+df.format(normalize(-3135.9347d,360.d)));
        System.out.println("Normalize function -54.7324 mod 2*pi should be 1.81866: " +df.format(normalize(-54.7324d,6.283185d)));
    }
}
